...
if __name__=='__main__':
    parser.add_argument('--root_dir', type=str, default='/Users/yoni/Projects/CommonFate/scenes')
    parser.add_argument('--n_shapes', type=int, default=1)
    parser.add_argument('--shape_type', type=str, default='superellipsoids', help='Options: superellipsoids | supertoroids | mixed')
